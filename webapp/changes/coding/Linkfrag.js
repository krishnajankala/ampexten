...
sap.ui.define([
	...
	function (
		...
		"use strict";
		return ControllerExtension.extend("customer.zampf0691.Linkfrag", {
			onSubmit: function(eve){
				MessageBox.show('Hey!! we have done developer extensibility');
			}
			// metadata: {
			...
			// 	 * @memberOf customer.zampf0691.Linkfrag
			// 	 */
			// 	onInit: function() {
			// 	},
